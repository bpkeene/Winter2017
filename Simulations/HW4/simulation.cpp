...
void Simulation::run(int nsteps, int printXYZ, bool production) {
    ...
    if (! (production) ) {
        for (int qq = 0; qq < (int) atoms.size(); qq++ ) {
    ...
    for (int q = 0; q < (int) atoms.size(); q++) {
    ...
    for (int i = 0; i < nsteps; i++) {
        ...
        for (int jj = 0; jj < (int) atoms.size(); jj++) {
            if (jj != idx) {
        ...
        if (acceptMove) {
            ...
            for (int kk = 0; kk < (int) atoms.size(); kk++) {
                if (kk != idx) {
            ...
            for (int jjj = 0; jjj < (int) atoms.size(); jjj++) {
                if (jjj != idx) {
...
void Simulation::updateDistancesMatrix(int idx) {
    ...
    int ii, jj;
    for (int i = 0; i < (int) distances[0].size(); i++) {
        if (i < idx) {
            ii = i;
            jj = idx;
        } else if (i > idx) {
...
void Simulation::ComputeTotalEnergy() {
    ...
    totalPE = 0.0;
    for (int i = 0; i < (int) (distances[0].size() - 1); i++) {
        for (int j = i+1; j < (int) distances[0].size(); j++) {
